...
@cli.command()
@click.pass_context
@click.option('--prog', default='mafft', help='''full path to MAFFT program,
				if a local installation is to be used''')
...
@cli.command()
@click.pass_context
@click.option('--prog', default='FastTreeMP', help='''full path to FASTTREE program,
				if a local installation is to be used''')
@click.option('--infile', default='genome_aln_ref.fna', show_default=True)
...
@cli.command()
@click.pass_context
@click.option('--prog', default='hyphy', help='''full path to HYPHY program,
				if a local installation is to be used''')
@click.option('--indr', default='prots_nmsa', show_default=True)
